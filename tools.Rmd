...
We can use `tab_spanner()` to add spanner columns. The `vars()` argument takes in the variables that the spanner column will cover.
...
x %>% 
  gt()%>%
   tab_header(title = md("**Enos Data Observations**"), 
              subtitle = "Gender, Income, and End Attitude from the Trains Data") %>% 
   tab_spanner(label = "Name of Spanner Column Here", vars(gender, income))
```
