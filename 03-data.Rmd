...
<!-- This looks really ugly on the actual website because we have parsing failures just out in the open. It looks like a column vs rowwise parsing failure, and it's really confusing if you see this kind of junk. -->
...
<!-- This needs an example, it's weird if we just have the text open like this. -->
