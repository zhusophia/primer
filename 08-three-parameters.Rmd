...
<!-- We will need to update the ch8 tibble creation to use other variables. -->

<!-- Stop using set.seed(). Maybe start using seed =  -->

<!-- DK: Review dummy variables in the context of the intercept model with categorical predictor. -->

<!-- DK: Also add a logistic model of liberal explained by income. (Need to put income in increments of 100,000.) Just barely significant! (Is this a three parameter model? I don't see an error term.) -->
