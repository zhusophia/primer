...
The interpretations of the parameters is now different. $\beta_0$ is now the average age of Republicans. This is the same interpretation as $\beta_1$ in the original set up. $beta_1$ is now the difference between the the average age of Republicans and that of Democrats. 
