...
<!-- Go through old MM comments and ensure which ones stay for next meeting. -->
...
*What is the expected age of a Democrat at a train station in the U.S. today?*

*In a group of train commuters in the U.S. today with three Democrats and three Republicans, what will the age difference be between the oldest Democrat and the youngest Republican?* 
...
*What is the largest causal effect of exposing U.S. train commuters today which still has a 1 in 10 chance of occurring?*

<!-- Clairfy -->

*What would you expect the income to be for a random 40 year old train commuterf in the U.S. today?*

*Among all train commuters in the U.S. today who have an income $100,000, what proportion are liberal?*

*Assume we have a group of eight train commuters in the U.S. today, two of whom make $100,000, two $200,000, two $300,000 and two $400,000. How many will be liberal?*
...
Justice, in data science, consists of three topics: representativeness, validity, and the data-generating mechanism, or model. 

Let's first consider the representativeness of the data. In order to determine if the data is representative, we must determine if we could treat the rows of the data as if they are random samples of the population table. In other words, we must determine if the data from 2012 in Boston is exchangeable with data from 2021 in the U.S.. 

Additionally, we must determine if the data is valid. In other words, we must figure out if the meaning of the columns is the same over the entire population table. For `party`, this would mean considering if the meaning of aligning as a "Democrat" or "Republican" has changed over the years. 

<!-- Explain more in above two paragraphs -->
