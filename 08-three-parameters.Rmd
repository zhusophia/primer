...
<!-- DK: We should have 4 models, in addition to the two here already. One is continuous right hand side variable. Maybe income ~ age. Clearly predictive, but not quite significant.  Also need age ~ party with an intercept. Both these are also three parameter models. Covering them makes chapter 9 easier. -->
