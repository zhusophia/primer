...
<!-- Add in that questions pertain to population of train commuters -->

### The Questions

*What is the expected age of a Democrat at a train station in the US today?*

*In a group of train commuters in the US today with three Democrats and three Republicans, what will the age difference be between the oldest Democrat and the youngest Republican?* 

*What is the average treatment effect, of exposing US train commuters today to Spanish-speakers, on their attitudes toward immigration?* 

*What is the largest causal effect of exposing US train commuters today which still has a 1 in 10 chance of occurring?*

<!-- Clairfy -->

*What would you expect the income to be for a random 40 year old train commuterf in the US today?*

*Among all train commuters in the US today who have an income $100,000, what proportion are liberal?*

*Assume we have a group of eight train commuters in the US today, two of whom make $100,000, two $200,000, two $300,000 and two $400,000. How many will be liberal?*
...
Justice consists of four topics: validity, stability, representativeness, and the model.
...
<!-- MM: kind of model should be discussing linear or logistic -->

Now, let's consider the type of model. Any model with age as its dependent variable will be predictive, not causal, for the simple reason that nothing, other than time, can change your age. You are X years old. It would not matter if you changed your party registration from Democrat to Republican or vice versa. Your age is your age.
...
Let's say that even though Boston is different from other US cities, we considered Boston to be perfectly representative of the US. Great, but this 2012 data could still not be representative due to a sampling bias. 
...
<!-- Add representativeness and validity -->
