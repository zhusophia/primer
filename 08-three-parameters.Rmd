...
<!-- Add lots of comments to this Rmd with initials MM: Done -->
...
<!-- MM: Discuss to Preceptor Tables and ideal data to answer our questions -->
...
<!-- MM: Tie above paragraph to selecting data that is relevant to the research question -->
...
<!-- MM: Relate back to research questions and the population for them -->

<!-- MM: Discuss whether the data comes from the same population as ideal preceptor table -->
...
<!-- MM: ch.5 states key aspects are representativeness, validity, and data generating mechanism -->
...
<!-- MM: Reinforce representativeness and validity of the data -->
...
<!-- MM: ideal preceptor table, what kind of data would we need, then look at data? -->
...
<!-- MM: should be three elements: representativeness, validity, and formula -->
...
<!-- MM: Add explanation of fit similar to how it was done previously? -->
