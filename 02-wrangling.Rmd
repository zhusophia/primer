...
<!-- Explain what (ijps <- inner_join(publishers, superheroes)) is doing. DK: Done. -->

<!-- Avoid eval = FALSE. If you are showing them the code, show them the results. (Example: tidy section.) How do you know the code works? DK: Done. -->

<!-- Replace flights with fec16. airlines are boring. Don't worry about that now. -->
