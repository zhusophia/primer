...
We need to "skip" the first row of the file because it does not contain actual data.
...
Let's look at the deparment with 644 make professors.
...
We can solve this problem by using backticks.
