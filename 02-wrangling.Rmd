...
<!-- Later: Replace flights with fec16. airlines are boring. -->
...
Note that `sample()` selects a random sample from a vector.
...
To explore regular expressions, we will use the `str_subset()` function, which pulls out all the values in a vector which match a given pattern.
