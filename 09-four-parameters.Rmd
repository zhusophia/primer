...
**The higher our value for `elpd_loo`, the better our model performs.** This means that, when comparing models, we want to select the model with the higher value for `elpd_loo`. Hint: the higher value will be the the value closest to 0, as the results for `elpd_loo()` are negative. 
