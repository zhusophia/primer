...
<!-- Transform variables goes first, then select variables. -->
...
<!-- MF: Discuss indicator & index variables prior to explaining guidelines? Not this week! -->
...
<!-- MF: Go through one of the datasets and explain whether we would include variables X, Y, and Z. Not this week.  --> 
...
<!-- DK: Gelman makes the relevant points. Ideal is totally new data after we submit our model. No cheating! Or, we can try to be disciplined and keep an out of sample. Discuss cross validation. Ultimate logic is leave one out validation. -->
