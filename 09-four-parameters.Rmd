...
<!-- MAKE SURE WE CAN SEE MODEL PRINTOUT with loo_compare(). If not, then hard code its value in the book directly. -->
...
<!-- Preceptor's Posterior is the posterior you would calculate if all the assumptions you made under Wisdom and Justice were correct. Sadly, they never are! So, you can never know Preceptor's Posterior. Your posterior will, you hope, be a closish approximation of Preceptor's Posterior. -->


<!-- Some discussion of population in parallel lines example at end. -->

<!-- Edit Justice section to make sense, given it now comes before courage. -->

<!-- Fix up math discussion. Don't use att_end as coefficient. -->

<!-- Change Justice section to discuss the math of three possible models you are considering. Predictive or am I doing causal? What is the treatment effect is my question? So, must be causal.  -->

<!-- Add a third model, att_end = treatment + att_start. Pick that one. -->

<!-- Add a question to Temperance and answer it. Probably posterior_epred(). Probably a causation question. Meaning the expected causal effect for a certain sort of person. Which is also a parameter in the regression, which is a good connection to make. -->

<!-- One sentence explaining what broom.mixed is for at start of chapter. -->
...
```{r}
fit_1 <- stan_glm(formula = att_end ~ treatment + liberal,
                  data = trains,
                  refresh = 0,
                  seed = 42)
