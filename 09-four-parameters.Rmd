...
<!-- MAKE SURE WE CAN SEE MODEL PRINTOUT with loo_compare(). If not, then hard code its value in the book directly. MF: Done. -->
...
<!-- Preceptor's Posterior is the posterior you would calculate if all the assumptions you made under Wisdom and Justice were correct. Sadly, they never are! So, you can never know Preceptor's Posterior. Your posterior will, you hope, be a closish approximation of Preceptor's Posterior. MF: This is included. -->

<!-- Some discussion of population in parallel lines example at end. MF: Done. -->

<!-- Edit Justice section to make sense, given it now comes before courage. MF: Done. -->

<!-- Fix up math discussion. Don't use att_end as coefficient. MF: Done. -->
...
<!-- Add a third model, att_end = treatment + att_start. Pick that one. MF: DONE. -->
...
<!-- One sentence explaining what broom.mixed is for at start of chapter. MF: Done. -->

<!-- Add Summary section MF: Done.-->
...
y = (intercept + liberal_true) + $$\beta_1$$(att_start)
...
To continue studying the `trains` data, we will now compare a number of models to see which one is superior at making predictions. 
