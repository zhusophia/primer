...
<!-- DK: Get axis labels and titles to use \sigma and \mu -->

<!-- DK: Add a second logistic model after urn, with an explanatory variable this time? Show why posterior_ functions are better than parameter games? -->
...
<!-- DK: Insert discussion about why we use logistic models. -->
...
ch7_b %>% 
  ggplot(aes(x = height, y = female)) +
    ...
    geom_line(aes(x = height, 
              ...
              color = "blue") +
    labs(title = "Gender and Height",
         subtitle = "A linear model cam produce probabilities outside 0 to 1",
         x = "Height (cm)",
         y = NULL,
         caption = "Data from NHANES") +
    scale_y_continuous(breaks = c(0, 1),
