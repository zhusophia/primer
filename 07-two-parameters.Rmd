...
<!-- I think the introduction of 7.1 (everything before 7.1.1) belongs outside of the "Wisdom" section entirely. Chapter 5 establishes that the cardinal virtues are parts of a process to answer your questions. Creating the questions themselves is not part of "Wisdom" (as per chapter 5) and therefore doesn't belong in that section, but rather right before it. GP: Done -->

<!-- Delete females from EDA plot and make a better plot.  Maybe it has both a histogram and a density overlayed. Or maybe not! I don't know. GP: Done -->
