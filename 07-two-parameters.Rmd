...
<!-- MF: In wisdom, added ideal Preceptor Table and population sections. -->

<!-- MF: In justice, added Population Table. We need to add representativeness and validity. -->

<!-- MF: In Temperance, added Three Levels of Knowledge. --> 
...
<!-- MF: If we are building to the version of Justice in CH11, should this section not include all of the new elements (population table, representativeness, validity)? Or should it include them, but in a more limited capacity? --> 
...
tibble(source = c("ideal Preceptor Table", "ideal Preceptor Table", "...",
  ...
  tab_style(cell_borders(sides = "right"),
            location = cells_body(columns = vars(source))) %>%
  tab_style(style = cell_text(align = "left", v_align = "middle", size = "large"), 
            locations = cells_column_labels(columns = vars(source))) %>%
  cols_align(align = "center", columns = TRUE) %>%
  cols_align(align = "left", columns = vars(source)) %>%
  fmt_markdown(columns = TRUE)  
```



 <!-- MF: Is math staying in Justice? How should it be incorporated? --> 
