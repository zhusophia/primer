...
Shifting away from dealing with beads, let's look at the `nhanes` dataset from National Health and Nutrition Examination Survey conducted by the Centers for Disease Control and Prevention and covering children and adults in America. 
...
Consider a subset of the `nhanes` data:
