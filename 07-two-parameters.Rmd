...
<!-- Add lots of comments to this chapter, using your initials. -->

<!-- Do the tutorial. -->

<!-- Read my comments. Make sense? -->

<!-- old stuff: -->

<!-- Clean up discussion of representativeness now that we are no longer quoting the details. Give a brief paragraph about how a non-representative sample might have happened. Are people in hospitals sampled? If there are certain categories of people that are harder to reach, then it may not be representative. Always think up reasons why your sample is not representative and then discuss the bias which might result. Also, you are sampling at a moment in time. There are always (potential time trends). -->
...
<!-- Remove ideal from ideal Preceptor Table. After chapter 4, there is only one notion of a "Preceptor Table." It is a table with the rows and columns such that, if there is no missing data, you can answer all the questions with easy algebra. -->
...
According to the CDC, individuals are invited to participate in NHANES based on a randomized process. 
