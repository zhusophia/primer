...
In any textbook, it will be tough to avoid the "toy problem" trap. The real world is complex. Any substantive decision problem includes a great deal of complexity and requires even more context. We do not have the time to get into that level of detail now, although Chapter \@ref(case-studies) provides some useful case studies. So, we simplify. We are going to create a model of height for adult men. We will then use that model to answer four questions:
