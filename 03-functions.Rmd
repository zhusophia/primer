...
<!-- add .groups, so no bad messages. DONE.-->
...
<!-- Read, and then delete, the Crooked Casino section. DONE.-->
...
<!-- MF: Should I modify this section to work with the my_sampler function instead of add_dice? -->
...
This works, but it is dangerous to invert the default behavior of a built-in function and to provide the user with no way to override this.
