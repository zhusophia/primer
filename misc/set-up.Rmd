...
This document provides a guide in setting up R/RStudio to work on *[The Primer](https://ppbds.github.io/primer/)*, both the book itself, [PPDBS/primer](https://github.com/PPBDS/primer), and the associated tutorials and data package: [PPDBS/primer.tutorials](https://github.com/PPBDS/primer.tutorials) and [PPDBS/primer.data](https://github.com/PPBDS/primer.data). There are three steps:
...
2) Make changes in the file you are editing. Knit to make sure they work. Commit with a message. Push to the repo on your Github account. And so on. 
