...
<!-- Population Table, by definition, always has three columns: Source, Time and ID (in that order), although Time might be replaced with the unit of time, like Year or Date. Think about just placing the Preceptor Table (and the data set) within a larger context. -->

<!-- All Population Tables have lots of ... (to indicate missing rows) since we need to highlight that the Population is big.  -->
...
<!-- Row for Population Table under assumptions are wrong. We have the outcome under either treatment or control for our Data rows, not for Population or Preceptor rows. -->
