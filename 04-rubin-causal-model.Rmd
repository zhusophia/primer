...
<!-- Add many comments with initials SZ:-->

<!-- Learn about captions in R Markdown. Maybe useful: https://bookdown.org/yihui/bookdown/figures.html. One option fig.cap in the cod chunk options. -->

<!-- Add one or two captions. -->

<!-- Do the tutorials. Send me the .rds. -->
