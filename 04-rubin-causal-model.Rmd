...
<!-- SZ: Not sure how to expand on this - you can't really calculate the estimand of a population table, can you? Revisit this after reading 6, 7 and 8. -->
...
<!-- The below numbers are now wrong. Replace them with the calculated numbers (+8 and -4) which are derived in the Two values for tau section.  -->
...
<!-- DK: Stick in the formula for estimating ATE with the assumption of a single tau. Average y for treated - average y for control. Right it however you like.  -->
...
DK: Are these numbers still right? Not sure!
