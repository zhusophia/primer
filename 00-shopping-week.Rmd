...
There are three tabs in this window, we'll be focusing on the Console and Terminal. When you first start R, the Console gives you some information about your version of R. At the time when this was written, 4.0.3 was the latest version of R! The Console is where you can type and run R code. For example, if you type 1 + 1 and hit return, the Console returns 2.
...
Whether you are working on FAS OnDemand or on your own computer, the next step is to copy and paste the following to the R Console:
...
The `rstudioapi` commands set sensible defaults for working with RStudio. You only have to execute those commands once. 
