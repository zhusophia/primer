...
Another point of confusion with many new R users is the idea of an R package. R packages, also known as R *libraries*, extend the functionality of R by providing additional functions and data. 
...
Let's install three of the packages which we will need in the *Primer*. (This step is not necessary if you are working on FAS OnDemand. These packages have already been installed for you.) At the Console pane within RStudio, type: 
...
Let's install two packages which are not available from CRAN: **primer.data** and **primer.tutorials**. (This step is not necessary if you are working on FAS OnDemand. These packages have already been installed for you, although you may need to reinstall them later in the semester if we update them.)  Copy and paste the following to the R Console:
...
* Installed, from Github, these two packages:
...
* Completed the Shopping Week tutorial, downloaded your answers and submitted them via Canvas.
