...
First, the book is for students in [Gov 1005: Big Data](https://www.davidkane.info/files/gov_1005_spring_2021.html), a course offered in the Government Department at Harvard University. Everything about the book is designed to make the experience of those students better. Some of the material here may be useful to students outside of this class, but I don't really care if it is.
...
Now, we will be installing a package which is not available from CRAN: **primer.data**. Copy and paste the following to the R Console:
...
For each chapter of the textbook, there is a corresponding tutorial available in the **primer.data** package. In order to access these tutorials, follow these steps:

1. Run `library(primer.data)` in the R Console.
