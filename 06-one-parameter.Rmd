...
<!-- Change axis labels as you like. Make better use of pedagogical opportunities. -->

<!-- Add code comments (if you want) which explain some of your choices. Think of them like footnotes. -->

<!-- If you like, improve the quality of the graphics as you go along. -->

<!-- THIS IS YOUR CHAPTER! Put multiple bad standard error discussions everywhere! -->

<!-- Delete all old code that you are not using. -->
...
<!-- Replace 6.1 (and other hard-coded numbers) with reference/label. -->

<!-- Add longer figure captions, at your discretion. Student should be able to look at figure, read its caption, and understand the whole thing. -->

<!-- Fix 816 -->

<!-- Show code for final plots. Add comments to that code. -->
...
<!-- MF: I took from explanations online, but still feel SE isn't crystal clear. Need to revisit. Agreed! -->
...
<!-- REWRITE THIS ENTIRE SECTION TO REFLECT FOCUS ON STANDARD ERROR. DK: Agreed! -->
...
<!-- INSERT RECAP FOR EACH SECTION WITH 2-3 IMPORTANT PIECES OF INFORMATION DK: YES. -->
