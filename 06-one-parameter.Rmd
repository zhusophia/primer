...
<!-- Questions: Main question for this section (and the whole chapter) is how much normal approximation do we want to teach? Normal approximation is the basis for alot of cool statistical tricks so I feel like it is worthwhile to learn, but also may be unfair to penalize students for not having a firm grasp of the concept. It is not super hard, so I support teaching it without the use of z scores and instead verbally explaining the properties and uses with lots of pictures, and really just trying to demonstrate that as the number of trials goes up the graph becomes more normal.  -->
