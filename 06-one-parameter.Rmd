...
<!-- The distribution of the hat things is, more or less, your posterior. -->

<!-- sqrt from hierarchy should be math symbol, not R function.  -->

<!-- Add this Q&A below the hierarchy. And clean it up! -->
...
<!-- MADs and standard deviations are, more or less, the same thing. They are both measures of the variability of a distribution. In most cases, they have very similar values. A *standard error* is also a standard devitaion. It is just the standard deviation of the distribution of the estimates, and that distribution of estimates is, more or less, your posterior. So, we can use MAD to describe that distribution. It just does not have a special name, like standard error.  -->

<!-- default comment formating is fine. Mostly fixed. -->

<!-- Show post_dist for n > 8 as whole dist with n > 8 colored red. Not >= 8. -->

<!-- format of Summary section. Use better math symbols. -->

<!-- Photo at the end of Evy or . .  -->

<!-- Purpose of two versions of Joint Distribution graphic. Maybe at least change color of key changes in second one in order to highlight why we are seeing this twice? Certainly add $p$ to the y-axis label, if not also to the tile. -->

<!-- Hypothesis test section. More detail? More like Khan Academy? Reference Gelman? "Null hyppthesis test." -->

<!-- Outlier discussion in Temperance not quite right. Model uncertainty generally does not cause us to change our the center of the posterior. It causes us to expand the MAD. Donald Rumsfeld (and Donal Rubin) say: "Get MAD!" Or maybe not. -->

<!-- Asserting a posterior distribution is, conceptually, the same as opening a casino and allowing people to place wagers on outcomes, with the odds consistent with your posterior. If your posterior is wrong, they will take all your money. That would be bad! -->
...
<!-- Rule of thumb: The world in the future is always more variable than our models would suggest. The entire point of the virtue of Temperance to be aware of that fact and take account of it. Courage --- that bold bastard --- comes along and says, "Here is the model! Let's calculate the posterior and open the casino!" Temperance --- quite the old woman from the point of view of that idiot Courage --- says, "Hold on, stupid! Yes, I can calculate the posterior, but we need to be cautious." Temerance is concerned with the tails, not the center. Limit the bets on the first few nights. Make sure our posterior is OK. Temperance is about the sensible management of the casino.  -->
