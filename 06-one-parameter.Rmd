...
<!-- RS: Only 2 glaring errors left in this chapter:  -->

<!-- a.) the way it handles SE. Some definitions are incorrect, and vocab/prose is clunky.  -->

<!-- b.) Summary section needs to be cleaned up, but that is no big deal. -->

<!-- RS: I also fixed the Pop Table -->
...
<!-- - f. calculating confidence intervals -->
