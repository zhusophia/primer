...
<!-- Switch the urn to 1,000 beads to make the math easier and the code quicker. Do not use number of red beads as unknown parameter. Use p, assumed to be continious, throughout. -->
