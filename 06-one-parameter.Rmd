...
Now that we have a virtual analog of our urn, we need a virtual analog of the shovel seen in Figure 6.2 to generate virtual samples of 50 beads. We're going to use `slice_sample()` and list-columns. 
...
# called within map(), we are performing slice_sample() upon our urn once (ID = 1)
