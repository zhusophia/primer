...
<!-- Fix using the posterior section. Give it a new name? Entire Answering the question section could be written to be more like Chapter 7. And code fix! -->

<!-- Make the stan_glm work directly connected to that. -->
...
<!-- Better way: Do not make the post object. It is confusing and unecessary. Instead, just work from x. Filter red_paddle = 17. -->
<!-- Those rows provide a natural weighting! No need to normalize yet! And then simulate from each of those rows! Passing in p to rbinom! Note that x now has two columns: p and red_paddle. -->

```{r}
# x %>% 
#   filter(red_paddle == 17) %>% 
#   mutate(new_reds = map(p, ~ rbinom(n = 1, 
#                                     size = 20,
#                                     prob = p)))
# Done! new_reds is the unnormalized posterior for how many reds
# you will see with a shovel of size 20.
...
<!-- MF: So, we just want to show stan_glm here, right? No explanations? Yes. Explain not to worry! -->
