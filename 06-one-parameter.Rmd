...
Assume that, as before, a shovel of size 50 drawn from the urn has returned 16 red beads and 34 white. Create an object which contains this data.

```{r}
shovel <- tibble(red = c(rep(1, 16), rep(0, 34))) %>% 
