...
<!-- Put ideal Preceptor table ahead of EDA. MF: Done. -->

<!-- Replace hard coded numbers. MF: Done --> 

<!-- Consider getting rid of state example, or moving it as a teaser to end of chapter 10. Could we make a similar point with an example from shaming? MF: Done.

<!-- p_00 = fcn_1(primary_00), should be p_00 = primary_00 == "Yes", MF: Done-->

<!-- Use fit_ instead of model_. Think about other conventions you want enforce. MF: Done.-->
