...
There are 50 parameters.

<!-- DK: Explain Bayesian shrinkage! Show a graphic which compares them. Just run lm, using tidy to gather, merge and plot, perhaps with posteriors, perhaps not. -->
