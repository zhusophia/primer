...
There are 51 parameters, an average for 50 states and $\sigma$.


<!-- DK: Switch above to using ggdist. -->

<!-- DK: Add a sensible discussion about whether or not we believe this.  -->
...
<!-- MF: Insert the math. Adjust the discussion to make clear which values apply to which parameters. -->
...
<!-- Be careful! This is messed up. It is the posterior for those with voting age zero, which is nonsense, so why look at it! -->
