...
<!-- We have message = FALSE below (and in three other places) because we were getting a weird message about group_by. Not sure why. Perhaps a bug in gt(). Maybe this will fix itself in a few months. -->
