...
<!-- MF: In some chapters, the Population Table is at the end of Wisdom. In others, it's at the start of Justice. Which should we use? -->

<!-- MF: Cardinal virtues of Wisdom and Justice are mostly fixed. Courage and Temperance fixes are priority for next week. -->

<!-- All our cool new way of doing Cardinal Virtues needs to be added.-->

<!-- Testing section makes no sense. MF: Fixed.  -->

<!-- Do we need the centering nonsense anymore, given that we explain it in chapter 9? No. So, don't center age. But, at some point (when showing simople model with just age) mention that the intercept for the line is at age = 0. MF: Done. -->
