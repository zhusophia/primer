...
<!-- Code blocks need comments. Teach students something! Approximately as many lines of comments as lines of code, or at least 50% as many.  -->

<!-- Add ID variable to all data creates for Two Models, Three Models and so on. -->
...
<!-- It would be nice if the 3d graphics did not "pop up" when knitting the chapter.  Create a reproducible example, with the reprex package (or with a new repo with a simple Rmd), to show the problem. Then ask on RStudio. -->

<!-- Should discuss the concept of "population" in each example of probability distributions. The population is the imaginary urn from which our data has been, or will be, drawn. Check out Section 5.1. In fact, re-read the whole Cardinal Virtues section.   -->
