...
* *Wisdom* begins with the Preceptor Table. What data, if we had it, would allow us to answer our question easily? Then, we explore the data we have. Are the data we have close enough to the data we want that we can consider all the data as coming from the same *population*? If not, we can't proceed further. 
