...
* *Wisdom* begins with the ideal Preceptor Table. What data, if we had it, would allow us to answer our question easily? We explore the data we have. Are the data we have close enough to the data we want that we can consider all the data as coming from the same *population*? If not, we can't proceed further. As John Tukey noted, "The combination of some data and an aching desire for an answer does not ensure that a reasonable answer can be extracted from a given body of data."
...
Second, we look at the data we have and perform an exploratory data analysis, an EDA. You can never look at your data too much.
...
First, the *data generating mechanism* is the mathematical formula, and associated error term, which relates covariates to our outcome variable.  
...
Third, confirm that the data we have accurately capturing the concepts we care about. Is the data *valid*, given the problem we are trying to solve? @roas write:
