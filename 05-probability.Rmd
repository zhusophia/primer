...
Third, a key concept is the "population", which is largely equivalent to rows of the ideal Preceptor Table, as discussed in Chapter \@ref(rubin-causal-model). @roas writes:
