...
<!-- We use "spoken aloud" paragraph about \rho twice. That should be fixed. -->

<!-- Should we bring on the topic of population in this chapter. If so, how? -->

<!-- Should we use Preceptor Tables, one for flipping coints, rolling dice and so on. Probably not. Too much! -->

<!-- Related is the question of Preceptor Tables is how to introduce the Question. We certainly need a question each time because, once we have the model, we have to show readers how to "work with" the distribution, and that requires a question to answer. Revisit this sentence: "All data science problems". -->
