...
<!-- Delete code rather comment it out. Students see code! And we can always get back old stuff via Github. -->

<!-- When building the chapter, we don't want rayshader images to pop up! -->

<!-- Learn about movies in rayshader.  -->

<!-- Each of 2 and 3 and N model section should begin with a question. All data science problems begin with a question. Then, the answer to that question, is the posterior which we create. -->

<!-- For the N model case only, we have a posterior and we should then use that posterior to do stuff, like what are the odds of at least 10 heads. Do it the way that chapter 6 does it by explicitly showing what it means to add up area under the curve. -->
