...
<!-- Add truth is out there image. Done.-->
...
height_data <-nhanes%>%
  ...
  arrange(age) %>%
  group_by(age) %>%
  summarize(height_average = mean(height))

  # mutate(height_average= mean(height)) %>%
  # summarise(age,height_average) %>%
