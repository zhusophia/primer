...
<!-- Delete the cardinal virtues? If we keep them, then introduce them properly, perhaps reviewing the iconography. At least we need to update them to represent our current thinking! -->
...
Third, a key concept is the "population," which is largely equivalent to the rows of the ideal Preceptor Table, as discussed in Chapter \@ref(rubin-causal-model). @roas writes:
