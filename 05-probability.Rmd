...
We also load the **rayshader** and **rgl** packages. We use them to create the 3-D plots below. You can read more about **rayshader** [here](https://www.rayshader.com/) but we will not be explaining how to use it in this *Primer*.
...
Second, confirm that the data we have accurately capturing the concepts we care about. Is the data *valid*, given the problem we are trying to solve? @roas write:
