...
<!-- Disease example is wrong, as discussed.  -->
...
<!-- Should discuss the concept of "population" in each example of probability distributions. The population is the imaginary urn from which our data has been, or will be, drawn.  -->
...
jd_disease <- tibble(p = rep(c(0.01, 0.5), 10000)) %>%
