...
<!-- DK: After the first sentence. Show a cool plot of gapminder data. Then do the talkety-talk. Then show the code. And then finish by promising to make that simple by the end of the chapter. Then finish the chapter by looking back at this code. Then show that code with animations and plotly! -->
...
gapminder %>%
  ...
  ggplot(aes(gdpPercap, lifeExp, size = pop, color = continent)) +
    ...
    scale_x_log10() +
    labs(
        subtitle = "Life Expectancy and GDP per Capita (1952-2007)",
