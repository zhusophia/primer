...
<!-- Go through all comments. Keep the ones you agree with. Delete the ones you do not. Once you fix whatever a comment complains about, delete the comment. -->

<!-- Make presidential approval animated. -->

<!-- Delete any graphics, like select, which are not useful! Don't forget to delete the png files from  01-visualization/images. -->
