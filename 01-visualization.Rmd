...
<!-- Delete any image which we are not using. You only need to check this Rmd. DONE-->
...
<!--UP TO YOU!  HL: should we explain why we make the argument formula = y~x? The reason is that R is concerned that we don't know exactly what model it is estimating. So, it is warning us that y is function of x. We make the warning go away by specifying that relationship in the argument. DONE -->
...
<!-- HL: it's kinda unclear what the relationship between this paragraph and quantiles is? Also I sort of think the definition of quantile is rather wordy and not super clear. So fix it! Is this right? I'm not 100 sure. -->
...
<!-- HL: should probably explain what after_stat does. So do so! This is a bad explanation but Done ish?-->
